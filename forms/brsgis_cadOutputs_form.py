...
class Ui_brsgis_cadOutputs_form(object):
    ...
    def retranslateUi(self, brsgis_cadOutputs_form):
        ...
        self.cb_contours.setText(_translate("brsgis_cadOutputs_form", "GOV-GIS-LIDAR 2FT CONTOUR"))
        self.cb_ae.setText(_translate("brsgis_cadOutputs_form", "GOV-GIS-FEMA-BFP-AE"))
        self.cb_ve.setText(_translate("brsgis_cadOutputs_form", "GOV-GIS-FEMA-BFP-VE"))
        self.cb_hat2015.setText(_translate("brsgis_cadOutputs_form", "GOV-GIS-HAT"))
        self.cb_parcels.setText(_translate("brsgis_cadOutputs_form", "GOV-GIS-PARCEL"))
        self.cb_slope.setText(_translate("brsgis_cadOutputs_form", "GOV-GIS-SLOPE"))
        self.label_10.setText(_translate("brsgis_cadOutputs_form", "NOTE: You MUST choose at least one."))
        self.cb_rdss.setText(_translate("brsgis_cadOutputs_form", "GOV-GIS-ROAD"))
