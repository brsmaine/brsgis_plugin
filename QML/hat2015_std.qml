...
<qgis version="3.0.2-Girona" simplifyDrawingHints="1" minScale="100000" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" simplifyDrawingTol="1" maxScale="0" simplifyAlgorithm="0" labelsEnabled="0" readOnly="0">
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory lineSizeScale="3x:0,0,0,0,0,0" lineSizeType="MM" scaleDependency="Area" sizeType="MM" backgroundColor="#ffffff" minScaleDenominator="-2.14748e+9" barWidth="5" minimumSize="0" width="15" penColor="#000000" opacity="1" penWidth="0" sizeScale="3x:0,0,0,0,0,0" diagramOrientation="Up" scaleBasedVisibility="0" maxScaleDenominator="1e+8" labelPlacementMethod="XHeight" penAlpha="255" height="15" enabled="0" rotationOffset="270" backgroundAlpha="255">
      <fontProperties description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" style=""/>
      <attribute label="" color="#000000" field=""/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings priority="0" linePlacementFlags="2" obstacle="0" placement="2" zIndex="0" dist="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value=""/>
        <Option name="properties"/>
