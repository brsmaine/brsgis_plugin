...
<qgis maxScale="0" simplifyDrawingTol="1" labelsEnabled="0" minScale="1e+8" simplifyAlgorithm="0" version="3.0.2-Girona" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" readOnly="0" simplifyMaxScale="1">
  ...
  <aliases>
    ...
    <alias index="3" name="" field="map_bk_lot"/>
    <alias index="4" name="" field="rev_no"/>
    <alias index="5" name="" field="k_no"/>
    <alias index="6" name="" field="name"/>
    <alias index="7" name="" field="address"/>
    <alias index="8" name="" field="town"/>
    <alias index="9" name="" field="job"/>
    <alias index="10" name="" field="date"/>
    <alias index="11" name="" field="initials"/>
    <alias index="12" name="" field="surveyor"/>
    <alias index="13" name="" field="notes"/>
    <alias index="14" name="" field="planbook"/>
    <alias index="15" name="" field="planpage"/>
    <alias index="16" name="" field="zipcode"/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="k_no"/>
    ...
    <default expression="" applyOnUpdate="0" field="surveyor"/>
    <default expression="" applyOnUpdate="0" field="notes"/>
    <default expression="" applyOnUpdate="0" field="planbook"/>
    <default expression="" applyOnUpdate="0" field="planpage"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="k_no" exp_strength="0"/>
    ...
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="job" exp_strength="0"/>
    ...
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="surveyor" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="notes" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="planbook" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="planpage" exp_strength="0"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="k_no" hidden="0" width="-1" type="field"/>
      ...
      <column name="job" hidden="0" width="-1" type="field"/>
      <column name="date" hidden="0" width="-1" type="field"/>
      <column name="initials" hidden="0" width="-1" type="field"/>
      <column name="surveyor" hidden="0" width="-1" type="field"/>
      <column name="notes" hidden="0" width="-1" type="field"/>
      <column hidden="1" width="-1" type="actions"/>
      <column name="planbook" hidden="0" width="-1" type="field"/>
      <column name="planpage" hidden="0" width="-1" type="field"/>
      <column name="rev_no" hidden="0" width="-1" type="field"/>
    </columns>
  </attributetableconfig>
  <editform>z:/LeightonProjects/0 - settings/gis/qgis/plugins/brsgis_plugin/ui/brs_k.ui</editform>
  <editforminit>formOpen</editforminit>
  <editforminitcodesource>1</editforminitcodesource>
  <editforminitfilepath>z:/LeightonProjects/0 - settings/gis/qgis/plugins/brsgis_plugin/brs_k_init.py</editforminitfilepath>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="planbook" editable="1"/>
    <field name="planpage" editable="1"/>
    <field name="rev_no" editable="1"/>
    <field name="size_no" editable="0"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="planbook"/>
    <field labelOnTop="0" name="planpage"/>
